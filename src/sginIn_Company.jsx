...
import "./test.css";
export function SginIn_Company() {
  return (
    <>
      <div className="container-fluid">
        <div className="row">
          ...
          >
            ...
            <div className="fw-bolder fs-5 text-light mt-2 ms-5">We help.</div>
          </div>
          <div className="col-sm-12 col-md-8 col-lg-7 col-xlg-7 bg-light">
            <div
              className=""
              style={{ width: "50%", margin: "2% auto", padding: ".9%" }}
            >
              <div className="fw-bolder fs-2">campany account</div>
